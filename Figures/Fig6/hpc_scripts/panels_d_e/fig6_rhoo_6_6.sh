...
do
  ...
  do
    ...
    do
      ...
      nohup Rscript epicon_script.R 96 $gridsize 0 "nosocial" "planner" 5.166426 7.513051 $rho_o 2.6 5.1 58000 0.1 1 "ngm_planner_$label" "R0" 2 $phi > logs/planner_$label.log 2>&1
    done
  done
done
